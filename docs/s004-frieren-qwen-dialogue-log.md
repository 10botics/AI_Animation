...
| Clone | Reused embedding `20260603T050516Z` (ICL pad at clone) — **OK** | Same ref |
...
**Deliverable (v2):** `outputs/voice/final/S004/s004_frieren_frieren_dialogue_v2_ja_20260604T042026Z.wav`

**Retired v1:** `s004_frieren_frieren_dialogue_v1_ja_20260603T070054Z.wav`

## Lip-sync (PixVerse)

**Base:** `outputs/video/final/S004_kling-v26-pro_i2v_anime-audio-12fps_20260527T065906Z_12fps_20260527T065906Z.mp4` · **start-sec:** `1.2`

```powershell
cd scripts
python lipsync_fal.py `
  --video "..\outputs\video\final\S004_kling-v26-pro_i2v_anime-audio-12fps_20260527T065906Z_12fps_20260527T065906Z.mp4" `
...
| Run | Audio | Output |
|-----|-------|--------|
| v1 (retired) | v1 WAV | `..._frieren_dialogue_v1_ja_pixverse_20260604T041552Z.mp4` |
| **v2** | v2 WAV | `LipsyncTests/..._frieren_dialogue_v2_ja_pixverse_20260604T042931Z.mp4` |
| v1 + Demucs | `s004_frieren_dialogue_v1_ja_demucs.wav` | `LipsyncTests/..._frieren_dialogue_v1_ja_demucs_pixverse_20260604T043949Z.mp4` |
