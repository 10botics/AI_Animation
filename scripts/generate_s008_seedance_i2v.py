"""
S008 — ByteDance **Seedance 2.0** image-to-video (`bytedance/seedance-2.0/image-to-video`).

**Stage_02:** **`present`** **MS** **B3** — daytime camp: traveler back to camera center; mage right with open grimoire;
third figure rear left. Same palette as S002/S006.

Default driver: **`Tests/Final/S008_nano-banana-2-edit_20260330T042818Z.png`**.

**Policy:** MS three-hander — near-static §4b wording; silent default; `--audio` after a clean pass.
...
NEAR_STATIC_MOTION_PROMPT = (
    ...
    "2.39:1, daytime Northern forest camp, overcast diffused canopy light, same composition as the reference still. "
...
def main() -> int:
    parser = argparse.ArgumentParser(description="S008 → Seedance 2.0 image-to-video")
