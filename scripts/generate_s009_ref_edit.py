"""
S009 — **present** WS: **Stark**, **Frieren**, **Fern** **walking** the **forest path** toward camera — **Frieren** carries **rectangular case** (ref `panels/panel_s009.png`).
...
Default ref: **`panels/panel_s009.png`**. Pass `--ref` to override.
"""
...
DEFAULT_REF = ROOT / "panels" / "panel_s009.png"
